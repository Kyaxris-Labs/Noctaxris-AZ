...
- ARM CRUD for `Microsoft.DBforPostgreSQL/flexibleServers` (lab)
- Properties stored as JSON theatre

## Not implemented

- Full Postgres without DinD
...
curl -H "Authorization: Bearer $ROOT_TOKEN" \
  "http://127.0.0.1:4599/subscriptions/$SUB/resourceGroups/rg/providers/.../flexibleServers/demo"
```

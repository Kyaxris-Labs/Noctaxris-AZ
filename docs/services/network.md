...
- ARM CRUD for `Microsoft.Network/virtualNetworks` (lab)
- Properties stored as JSON theatre

## Not implemented

- Peering, private endpoints, DDoS plans
...
curl -H "Authorization: Bearer $ROOT_TOKEN" \
  "http://127.0.0.1:4599/subscriptions/$SUB/resourceGroups/rg/providers/.../virtualNetworks/demo"
```

...
const providerKey = "Microsoft.Communication/emailServices"
const armType = "Microsoft.Communication/emailServices"

// Handler serves Microsoft.Communication/emailServices ARM lite.
type Handler struct {
	Store *store.Store
...
func (h *Handler) Register(mux *http.ServeMux) {
	base := "/subscriptions/{sub}/resourceGroups/{rg}/providers/Microsoft.Communication/emailServices"
	...
	mux.HandleFunc("POST /emails:send", h.sendEmail)
}

func (h *Handler) put(w http.ResponseWriter, r *http.Request) {
	if !h.require(w, r, "Microsoft.Communication/emailServices/write") {
		return
	}
...
func (h *Handler) get(w http.ResponseWriter, r *http.Request) {
	if !h.require(w, r, "Microsoft.Communication/emailServices/read") {
		return
	}
	sub, rg, name := r.PathValue("sub"), r.PathValue("rg"), r.PathValue("name")
...
func (h *Handler) del(w http.ResponseWriter, r *http.Request) {
	if !h.require(w, r, "Microsoft.Communication/emailServices/delete") {
		return
	}
...
func resourceJSON(sub, rg, name, location string, props map[string]any) map[string]any {
	id := "/subscriptions/" + sub + "/resourceGroups/" + rg + "/providers/Microsoft.Communication/emailServices/" + name

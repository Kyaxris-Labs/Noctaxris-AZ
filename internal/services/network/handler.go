...
const providerKey = "Microsoft.Network/virtualNetworks"
const armType = "Microsoft.Network/virtualNetworks"

// Handler serves Microsoft.Network/virtualNetworks ARM lite.
type Handler struct {
	Store *store.Store
...
func (h *Handler) Register(mux *http.ServeMux) {
	base := "/subscriptions/{sub}/resourceGroups/{rg}/providers/Microsoft.Network/virtualNetworks"
...
func (h *Handler) put(w http.ResponseWriter, r *http.Request) {
	if !h.require(w, r, "Microsoft.Network/virtualNetworks/write") {
		return
	}
...
func (h *Handler) get(w http.ResponseWriter, r *http.Request) {
	if !h.require(w, r, "Microsoft.Network/virtualNetworks/read") {
		return
	}
	sub, rg, name := r.PathValue("sub"), r.PathValue("rg"), r.PathValue("name")
...
func (h *Handler) del(w http.ResponseWriter, r *http.Request) {
	if !h.require(w, r, "Microsoft.Network/virtualNetworks/delete") {
		return
	}

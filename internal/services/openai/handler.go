...
const providerKey = "Microsoft.CognitiveServices/accounts"
const armType = "Microsoft.CognitiveServices/accounts"

// Handler serves Microsoft.CognitiveServices/accounts ARM lite.
type Handler struct {
	Store *store.Store
...
func (h *Handler) Register(mux *http.ServeMux) {
	base := "/subscriptions/{sub}/resourceGroups/{rg}/providers/Microsoft.CognitiveServices/accounts"
	...
	mux.HandleFunc("POST /openai/{name}/chat/completions", h.chatCompletions)
}

func (h *Handler) put(w http.ResponseWriter, r *http.Request) {
	if !h.require(w, r, "Microsoft.CognitiveServices/accounts/write") {
		return
	}
...
func (h *Handler) get(w http.ResponseWriter, r *http.Request) {
	if !h.require(w, r, "Microsoft.CognitiveServices/accounts/read") {
		return
	}
	sub, rg, name := r.PathValue("sub"), r.PathValue("rg"), r.PathValue("name")
...
func (h *Handler) del(w http.ResponseWriter, r *http.Request) {
	if !h.require(w, r, "Microsoft.CognitiveServices/accounts/delete") {
		return
	}

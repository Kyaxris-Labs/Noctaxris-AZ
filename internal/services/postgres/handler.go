...
const providerKey = "Microsoft.DBforPostgreSQL/flexibleServers"
const armType = "Microsoft.DBforPostgreSQL/flexibleServers"

// Handler serves Microsoft.DBforPostgreSQL/flexibleServers ARM lite.
type Handler struct {
	Store *store.Store
...
func (h *Handler) Register(mux *http.ServeMux) {
	base := "/subscriptions/{sub}/resourceGroups/{rg}/providers/Microsoft.DBforPostgreSQL/flexibleServers"
...
func (h *Handler) put(w http.ResponseWriter, r *http.Request) {
	if !h.require(w, r, "Microsoft.DBforPostgreSQL/flexibleServers/write") {
		return
	}
...
func (h *Handler) get(w http.ResponseWriter, r *http.Request) {
	if !h.require(w, r, "Microsoft.DBforPostgreSQL/flexibleServers/read") {
		return
	}
	sub, rg, name := r.PathValue("sub"), r.PathValue("rg"), r.PathValue("name")
...
func (h *Handler) del(w http.ResponseWriter, r *http.Request) {
	if !h.require(w, r, "Microsoft.DBforPostgreSQL/flexibleServers/delete") {
		return
	}

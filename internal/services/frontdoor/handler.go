...
const providerKey = "Microsoft.Cdn/profiles"
const armType = "Microsoft.Cdn/profiles"

// Handler serves Microsoft.Cdn/profiles ARM lite.
type Handler struct {
	Store *store.Store
...
func (h *Handler) Register(mux *http.ServeMux) {
	base := "/subscriptions/{sub}/resourceGroups/{rg}/providers/Microsoft.Cdn/profiles"
...
func (h *Handler) put(w http.ResponseWriter, r *http.Request) {
	if !h.require(w, r, "Microsoft.Cdn/profiles/write") {
		return
	}
...
func (h *Handler) get(w http.ResponseWriter, r *http.Request) {
	if !h.require(w, r, "Microsoft.Cdn/profiles/read") {
		return
	}
	sub, rg, name := r.PathValue("sub"), r.PathValue("rg"), r.PathValue("name")
...
func (h *Handler) del(w http.ResponseWriter, r *http.Request) {
	if !h.require(w, r, "Microsoft.Cdn/profiles/delete") {
		return
	}
...
func resourceJSON(sub, rg, name, location string, props map[string]any) map[string]any {
	id := "/subscriptions/" + sub + "/resourceGroups/" + rg + "/providers/Microsoft.Cdn/profiles/" + name
